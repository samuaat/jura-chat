...
const LEGAL_JSON_LD = {
  ...
  "@type": "WebPage",
  "@id": `${CANONICAL}/jogi-nyilatkozat/#page`,
  url: `${CANONICAL}/jogi-nyilatkozat`,
  name: "Jogi nyilatkozat – JURA",
  inLanguage: "hu-HU",
  isPartOf: {
  ...
  description:
    "Jogi nyilatkozat a JURA kísérleti jogi AI-asszisztens használatáról: felelősségkorlátozás, nem minősül jogi tanácsadásnak, és nem hoz létre ügyvéd–ügyfél viszonyt.",
} as const;
          ...
          <div className="space-y-6 text-sm leading-relaxed text-slate-800">
            ...
            <section>
              ...
              <p className="mb-2">
                ...
                szövegjavaslatok{" "}
                <strong>nem minősülnek jogi tanácsadásnak</strong>. A rendszer
                nem képes figyelembe venni az egyes ügyek minden releváns
                körülményét, ezért az általa generált tartalom{" "}
              ...
              <ul className="mb-2 ml-5 list-disc space-y-1">
                ...
                <li>
                  ...
                  jogszabály alapján kifejezetten ügyvédi tevékenységnek
                  minősül.
                </li>
              </ul>
              <p>
                ...
                <strong>
                  hivatásos jogi szakember (pl. ügyvéd) felkeresése szükséges
                </strong>
                .
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-2">
                A JURA használata{" "}
                <strong>nem hoz létre ügyvéd–ügyfél viszonyt</strong>, és nem
                alapoz meg semmilyen szerződéses vagy megbízási jogviszonyt a
                felhasználó és a rendszer üzemeltetője között.
              </p>
              <p className="mb-2">
            ...
            <section>
              ...
              <p>
                ...
                rendelkezések{" "}
                <strong>nem minősülnek hiteles jogszabály-közlésnek</strong>.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-2">
                ...
                megkötését –{" "}
                <strong>a felhasználó saját felelősségére</strong> történik.
              </p>
              <p className="mb-2">
              ...
              <p>
                ...
                <strong>
                  nem érinti a jogszabály által nem kizárható felelősséget
                </strong>
                , így különösen nem érinti a kötelező fogyasztóvédelmi
                rendelkezésekből eredő jogokat és jogorvoslati lehetőségeket,
                valamint a szándékosan okozott kárért való felelősséget.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-2">
                ...
                összevetni, és szükség esetén{" "}
                <strong>jogi szakember véleményét kérni</strong>.
              </p>
              <p>
                A felhasználó különösen köteles tartózkodni attól, hogy a
                rendszer válaszait{" "}
                <strong>önmagukban, ellenőrzés nélkül</strong> használja fel
                olyan döntések meghozatalához, amelyek jelentős jogi, pénzügyi
                vagy személyes következményekkel járhatnak.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                A módosítások a{" "}
                <strong>honlapon való közzététellel</strong> válnak hatályossá.
                Amennyiben a módosítás a felhasználók jogait vagy
